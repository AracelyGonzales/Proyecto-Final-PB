...
int main()
{
    ...
    Empleado empleado1(202301, 5, "Aracely Sharick", "Gonzales Gonzales");
    Empleado empleado2(202302, 4, "Aladana Arleth", "Medina Ortega");
    Empleado empleado3(202303, 7, "Akemi Anjali", "Zambrano Lama");

    //Se define una lista de los autos que hay en la tienda
    ...
    /*se asigna a cada empleado las ventas que ha realizado, debido a que si los mostramos en pantalla
    ...
    if (accion == 1)
    {
        ...
        /* Se pone un bucle en el cual se da un límite de números de intentos, si estos se terminan,
        ...
        if (contra1 == contra2)
        {
            ...
            cout << "\nSeleccione que empleado desea evaluar \n->";
            cin >> selec_empleado;
            while(selec_empleado > 3 || selec_empleado < 1)
            {
                cout << "El numero de empleado es invalido. Ingrese numero de empleado valido"<<endl;
                cin >> selec_empleado;
            }
            ofstream archivo("Reporte.txt");

            /*Selección del empleado, para mostrar el reporte de ventas*/
            if (selec_empleado == 1)
            {
                ...
                archivo << left << setw(31) << "|Venta Total: ";
                archivo << setw(5) << ": s/";
                archivo << right << setw(7) << suma << " |\n";
                
                //condición de porcentaje de comisión de acuerdo a las ventas
                if (empleado1.getCantidadVendidos() >= 5)
                {
                    total_comisiones = suma * 0.005;
                }
                else
                {
                    (empleado1.getCantidadVendidos() < 5);
                    total_comisiones = suma * 0.003;
                }
    ...
    if (accion == 2)
    {
        system("cls"); //para limpiar la pantalla y no muestre lo anterior
        ...
        {
            system("cls");
            //mostrando MODELOS de la marca HYUNDAI
